...
export default function Navbar() {
  ...
  const { totalItems = 0 } = useCart(); // Pastikan ada default value
  ...
  useEffect(() => {
    setIsClient(true); // Pastikan komponen hanya berjalan di client-side
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden md:flex space-x-4">
              ...
              <Link href="/categories" className="text-gray-700 hover:scale-105 transition-transform">
                Categories
              </Link>
            </div>
          </div>
            ...
            {isClient ? (
              isLoggedIn === null ? (
                ...
                <div className="relative">
                  <button onClick={() => setIsDropdownOpen(!isDropdownOpen)} className="flex items-center text-gray-700 hover:text-primary transform transition-transform hover:scale-105">
                    <User size={24} />
                  </button>
                  {isDropdownOpen && (
